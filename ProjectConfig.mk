...
#modified for b1 bootanimation by cheng.wang 20180718 start
BOOT_LOGO = fwvgaplus
#modified for b1 bootanimation by cheng.wang 20180718 end
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_MTK_SDK =
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO =CY-B1-F8018
...
#ITD:modify BFBLYB-7 jie.liu 180806 Start
CUSTOM_HAL_CAM_CAL = gc5025_otp dummy_eeprom
CUSTOM_HAL_COMBO = mt6580
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = gc5025_mipi_raw gc5025broad_mipi_raw gc8c34_mipi_raw gc8c34broad_mipi_raw gc5025black_mipi_raw gc5025blackbroad_mipi_raw gc8c34black_mipi_raw gc8c34darkbroad_mipi_raw
CUSTOM_HAL_LENS = dw9714af dummy_lens
CUSTOM_DARK_COLOR = yes
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_HAL_MAIN_IMGSENSOR = gc5025_mipi_raw gc5025broad_mipi_raw gc5025black_mipi_raw gc5025blackbroad_mipi_raw
#ITD:modify BFBLYB-7 jie.liu 180806 End
CUSTOM_HAL_MAIN_LENS = dw9714af
CUSTOM_HAL_MSENSORLIB =akl
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
#ITD:modify BFBLYB-7 jie.liu 180712 Start
CUSTOM_HAL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = gc8c34_mipi_raw gc8c34broad_mipi_raw gc8c34black_mipi_raw gc8c34darkbroad_mipi_raw
#ITD:modify BFBLYB-7 jie.liu 180712 End
#ITD:ADD CAMERA_3RD esther.zhu.WB 180807 Start
TRAN_CAMERA_FEATURE_V1 = yes
TRAN_CAMERA_ARCSOFT_BEAUTY = yes
TRAN_CAMERA_FRONT_MIRROR = yes
TRAN_CAMERA_VISIDON_ASD = yes
#ITD:ADD CAMERA_3RD esther.zhu.WB 180807 End
CUSTOM_HAL_SUB_LENS = dummy_lens
CUSTOM_HIFI_SENSORS = no
CUSTOM_KERNEL_ACCELEROMETER = yes
#modify BFBLYB-5 by jixiaopan 20180709 start
#CUSTOM_KERNEL_ALSPS is not set
CUSTOM_KERNEL_PS = yes
#modify BFBLYB-5 by jixiaopan 20180709 end
CUSTOM_KERNEL_ANSWER_CALL_SENSOR =
CUSTOM_KERNEL_BAROMETER =
CUSTOM_KERNEL_BATTERY = battery
CUSTOM_KERNEL_CAMERA = camera
#ITD:modify BFBLYB-7 jie.liu 180806 Start
CUSTOM_KERNEL_CAM_CAL = gc5025_otp dummy_eeprom
#ITD:modify BFBLYB-7 jie.liu 180806 End
...
#ITD:modify BFBLYB-7 jie.liu 180712 Start
CUSTOM_KERNEL_IMGSENSOR = gc5025_mipi_raw gc5025broad_mipi_raw gc8c34_mipi_raw gc8c34broad_mipi_raw
#ITD:modify BFBLYB-7 jie.liu 180712 End
...
#ITD:modify BFBLYB-7 jie.liu 180712 Start
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5025_mipi_raw gc5025broad_mipi_raw
#ITD:modify BFBLYB-7 jie.liu 180712 End
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc8c34_mipi_raw gc8c34broad_mipi_raw
#ITD:modify BFBLYB-7 jie.liu 180712 End
...
#Modify BFBLYB-4 by xingsui.yang for modem p1 20180709 start
CUSTOM_MODEM = b1_f8018_drdi
#Modify BFBLYB-4 by xingsui.yang for modem p1 20180709 end
...
LCM_FAKE_WIDTH = 0
LCM_HEIGHT = 960
#modify by suwen.huang 20180712 start
LCM_WIDTH = 480
#modify by suwen.huang 20180712 end
LIGHT_NVRAM_DAEMON = no
LINUX_KERNEL_VERSION = kernel-3.18
LOVELYFONTS_ICON_SHOW = no
#zhanyang.duan BFBLYB-126 20180806 begin
LOVELYFONTS_SUPPORT = no
#zhanyang.duan BFBLYB-126 20180806 end
MAXIM_SPEAKER_SUPPORT = no
MD32_TOOLCHAIN_MODULE = IPDesigner/12R2.36-64
MD5_SIZE = 0x01600000
MD5_SMEM_SIZE = 0x00200000
#modify BFBLYB-5 by jixiaopan 20180711 start
MICROTRUST_TEE_SUPPORT = yes
TRAN_TEE_DRAM_SIZE_16 = no
#modify BFBLYB-5 by jixiaopan 20180711 end
MNTL_SUPPORT = no
...
MTK_AEE_SUPPORT = yes
#modify BFBLYB-8 by sihai.jia 20180627 start
MTK_AGPS_APP = no
#modify BFBLYB-8 by sihai.jia 20180627 end
MTK_AIV_SUPPORT = no
...
#modify by haiping.bai 20180709 start
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
#modify by haiping.bai 20180709 end
...
MTK_BUILD_VERNO=B1f-F8018GH-OGo-190425V60
FINGERPRINT_BUILD_VERNO=GH-190425V60
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
MTK_CAMERA_APP = no
#CameraAp: modify BFBLYB-28 by kai.pan 20180723 start
MTK_CAMERA_APP_VERSION = tecnocamera2
#CameraAp: modify BFBLYB-28 by kai.pan 20180723 end
...
# modify BFBLYB-3 by di.qian 20180709 start
MTK_FACTORY_MODE_IN_GB2312 = no
# modify BFBLYB-3 by di.qian 20180709 end
...
#PPD: modify by qianwen.guo for Google requirement in 1G device b1_GO 180726 start
MTK_GMO_RAM_OPTIMIZE = yes
MTK_GMO_ROM_OPTIMIZE = yes
#PPD: modify by qianwen.guo for Google requirement in 1G device b1_GO 180726 end
...
#TDD:add for KBQJHBLEW-444 by yulichen 20181023 start
MTK_LIVEWALLPAPER_APP = no
#TDD:add for KBQJHBLEW-444 by yulichen 20181023 end
MTK_LOADER_BACKUP = yes
MTK_LOG2SERVER_APP = no
MTK_LOG2SERVER_INTERNAL = no
MTK_LOG_CUSTOMER_SUPPORT = yes
#modify BFBLYB-8 by sihai.jia 20180627 start
MTK_LOG_SUPPORT_GPS = no
#modify BFBLYB-8 by sihai.jia 20180627 end
...
#PPD: modified ProcessManager by hanhao 20180720 start
#MTK_RUNNING_BOOSTER_DEFAULT_ON = yes
#MTK_RUNNING_BOOSTER_SUPPORT = yes
#PPD: modified ProcessManager by hanhao 20180720 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#Modify BFBLYB-25 by fangmengyao 20180720 start
MTK_UART_USB_SWITCH = yes
#Modify BFBLYB-25 by fangmengyao 20180720 end
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#zhanyang.duan BFBLYB-126 20180806 end
NAND_OTP_SUPPORT = no
#add by suwen.huang 20180712 start
TRAN_LCM_SUPPORT = yes
#add by suwen.huang 20180712 end
...
#APP: Modify BFBLYB-227 by zhaoyang.shi 20180813 start
# MTK_DEFAULT_WRITE_DISK = no
MTK_DEFAULT_WRITE_DISK = yes
#APP: Modify BFBLYB-227 by zhaoyang.shi 20180813 end
...
CUSTOM_TRAN_PROJECT=tran_b1f
CUSTOM_TRAN_BOM=tran_b1f_g1
# add end


#TDD:add by huangweijia for XWWJHBLYWO-232 on 2018.07.09 start
RLK_INFINIX_AGINGFUNCTION=yes
TRAN_AGFUNCTION_FM_SUPPORT=yes
#TDD:add by huangweijia for XWWJHBLYWO-232 on 2018.07.09 end

#TDD:add by wenqiang.zhang INYPROHSJB-67 20180509 for gmsexpress start
TRAN_GMSEXPRESS_SUPPORT = yes
TRANSSION_CLIENT_ID = android-transsion-tecno-rev1
#TDD:add by wenqiang.zhang INYPROHSJB-67 20180509 for gmsexpress end

#TDD: add by shouhui.li Midtest3.0 start
RLK_MIDTEST_SUPPORT = yes
TRAN_TECNO_MIDTEST_NEW_SUPPORTED = yes
TRAN_TECNO_MIDTEST_SUPPORTED = yes
TRAN_MIDTEST_SUPPORT = yes
TRAN_MIDTEST_CLEARPA_SUPPORTED = no
TRAN_MIDTEST_BCAMERA_AF_SUPPORTED = yes
TRAN_MIDTEST_DUAL_CAMERA_SUPPORTED = no
TRAN_MIDTEST_GYRO_SENSOR_SUPPORTED = no
TRAN_MIDTEST_DISTANCE_SENSOR_SUPPORTED = no
TRAN_MIDTEST_LIGHT_SENSOR_SUPPORTED = no
TRAN_MIDTEST_COMPASS_SUPPORTED = no
TRAN_MIDTEST_FLASH_FORWARD_SUPPORTED = yes
TRAN_MIDTEST_TRICOLOR_LEDS_SUPPORTED = no
TRAN_MIDTEST_DUAL_MIC_SUPPORTED = no
TRAN_MIDTEST_HALL_SUPPORTED = no
TRAN_MIDTEST_CAMERAKEY_SUPPORTED = no
TRAN_MIDTEST_FINGERPRINTF_SUPPORTED = yes
TRAN_MIDTEST_OTG_NO_SUPPORTED = yes
TRAN_MIDTEST_BUTTON_LEDS_SUPPORTED = no
TRAN_MIDTEST_INDICATOR_LIGHT_SUPPORTED = no
TRAN_MIDTEST_DUAL_CAMERA_WESTALGO = no
TRAN_MIDTEST_FINGER_SW9362_SUPPORTED = no
MIDTEST_FINGER_SW9088_SUPPORTED = yes
#TDD: add by shouhui.li Midtest3.0 end
#add BFBLYB-3 by di.qian 20180711 start
TRAN_FT_CUSTOM_PERMISSION_SUPPORT = yes
TRAN_FT_RESET = yes
TRAN_FT_REBOOT = yes
TRAN_FT_CUSTOM_SHELL = yes
TRAN_FT_BENCHFLAG_SUPPORT = yes
#add BFBLYB-3 by di.qian 20180711 end

#PPD: add BFBLYB-18 remove activity when app is killed by peng.zhang 20180719 start
TRAN_RM_ACTIVITY_SUPPORT = yes
#PPD: add BFBLYB-18 remove activity when app is killed by peng.zhang 20180719 end

#PPD: add BFBLYB-18 vm param by peng.zhang 20180719 start
TRAN_VM_STARTSIZE = 8m
TRAN_VM_MINFREE_SIZE = 2m
TRAN_VM_MAXFREE_SIZE = 8m
#PPD: add BFBLYB-18 vm param by peng.zhang 20180719 end

#APP: Add by fuyu for BFBLYB-32 20180725 start
TRAN_OS_CALCULATOR_SUPPORT = yes
#APP: Add by fuyu for BFBLYB-32 20180725 end

#TDD: add CFLHLSS-20 by bo.zhou 20180713 start
BUILD_GMS=yes
BUILD_AGO_GMS=yes
#TDD: add CFLHLSS-20 by bo.zhou 20180713 end
#SID:add BFBLYB-16 by lilonglong 20180717 start
RLK_PROJECT=tecno_b1
TRAN_OS_TYPE=HIOS
TRAN_OS_LITE=yes
TRANSSION_PRODUCT_DEVICE := TECNO-B1f
TRANSSION_PRODUCT_NAME := F8018
TRANSSION_DEVICE_NAME := TECNO POP 2F
TRANSSION_PRODUCT_MODEL := TECNO B1f
TRANSSION_BRAND_NAME := TECNO
TRANSSION_PRODUCT_MANUFACTURER = TECNO MOBILE LIMITED
TRANSSION_PRODUCT_BOARD = TECNO-B1f
RLK_PROJECT_NAME = b1_f8018_b1
TRAN_DISABLE_ADB_RSA_SUPPORT = no
TRAN_RCS_GO_SUPPORT = yes
TRANSSION_BUILD_GO=yes
OS_NOTEBOOK_SUPPORT = yes
#APP: Modify by zhongyuan.li for BFBLYB-1285 20190328 start
TRANSSION_FACEBOOK_GROUP_DELETE = no
#APP: Modify by zhongyuan.li for BFBLYB-1285 20190328 end
TRANSSION_EAGLEEE_DELETE = yes
TRANSSION_KIKA_DELETE = yes

#APP: modify for BFBLYB-1239 yanjie.wang 20190327 start
TRAN_LAUNCHER_CONFIG = B1F
#APP: modify for BFBLYB-1239 yanjie.wang 20190327 end

MTK_SOUNDRECORDER_APP = yes
TRAN_CARLCARE_UNINSTALL_SUPPORT = yes
TRAN_FYNGEEZ_UNINSTALL_SUPPORT = yes
#TCD:add BFBLYB-1001 by wenqiang.zhang 20190307 start
#TRANSSION_CALENDARGOOGLE_UNINSTALL_SUPPORT = no
#TCD:add BFBLYB-1001 by wenqiang.zhang 20190307 end
TRAN_SYS_STASL = yes
TRAN_BOOMPLAY_SUPPORT = yes
TRANSSION_YOUTUBE_SUPPORT = yes
#SID:add BFBLYB-16 by lilonglong 20180717 end
#BSP:add AWESLITE-2 by haiping.bai 20180720 start
TRAN_AUDIOTEST_SUPPORT = yes
#BSP:add AWESLITE-2 by haiping.bai 20180720 end
#BSP: add BFBLYB-3 by di.qian 20180718 start
TRAN_SEC_FILE_COPY_SUPPORT = yes
# BSP: add BFBLYB-3 by di.qian 20180718 end

#*********************PPD Feature Only Start******************************#
#PPD: add ProcessManager by hanhao 20180720 start
TRAN_PROCMGR_SUPPORT=yes
TRAN_PROCMGR_MODE=deep
TRAN_LMK_BOOST_SUPPORT=yes
#PPD:add syncHeartBeat switch by yangjian 20180720 start
TRAN_SYNC_GROUP_SUPPORT = yes
#PPD:add syncHeartBeat switch by yangjian 20180720 end
#PPD: add ProcessManager by hanhao 20180720 end
...
#PPD add by zeyang.li for pnp feature at 20180723 start
TRAN_PNPMGR_SUPPORT = yes
#PPD add by zeyang.li for pnp feature at 20180723 end
#*********************PPD Feature Only End******************************#
...
TECNO_CAMERA_FULLSCREEN_SUPPORT = yes
#CameraAp: modify BFBLYB-28 by kai.pan 20180723 end
#CameraAp: modify BFBLYB-228 by kai.pan 20180822 start
HIOS_CAMERA_USE_GOOGLE_PHOTOS_SUPPORT = yes
HIOS_CAMERA_SINGLE_DENOISE = yes
HIOS_CAMERA_DISABLE_ZSD = yes
#CameraAp: modify BFBLYB-228 by kai.pan 20180822 end
#BSP:add CFQHLYE-14 by hong.zhang for porting f2fs 201800725 start
TRAN_USE_F2FS = yes
#BSP:add CFQHLYE-14 by hong.zhang for porting f2fs 20180725 end
#APP:add BFBLYB-33 by zhangxu 20180730 start
OS_INADVERTENT_SUPPORT = no
#APP:add BFBLYB-33 by zhangxu 20180730 end
#BSP:add BFBLYB-968 by yong.jiang 20190116 start
TRAN_FINGERPRINT_SUPPORT= sunwave_tee
#BSP:add BFBLYB-968  by yong.jiang 20190116 end
#TSD modify BFBLYB-99 by zhangya 2018.08.02 start
TRAN_RCS_SUPPORT = yes
#TSD modify BFBLYB-99 by zhangya 2018.08.02 start
#APP:add BFBLYB-106 by lei.du 20180803 start
OS_DOCUMENTSUI_LITE_CUSTOM = yes
#APP:add BFBLYB-106 by lei.du 20180803 end

#APP:add AWESLITE-33 by zhanyang.duan 20180809 begin
RLK_MULTI_TOUCH_SUPPORT = no
#APP:add AWESLITE-33 by zhanyang.duan 20180809 end
#BSP:add XLLJHBLEW-186 by hao.wu2 20180809 start
TRAN_TKV_SUPPORTED = no
#BSP:add XLLJHBLEW-186 by hao.wu2 20180809 end
#SID: add BFBLYB-355 jinbao 20180727 start
TRAN_COSOFTWARE_SUPPORT=no
TRAN_COSOFTWARE_GROUP_NAME=b1_f8018_b1_efuse
#SID: add BFBLYB-355 jinbao 20180727 end
#APP:add BFBLYB-435 by lizhao 20180820 start
#app: modify BFBLYB-1127 by xu.tang 2019.03.18 start
OS_FINGERPRINT_SUPPORT = yes
#app: modify BFBLYB-1127 by xu.tang 2019.03.18 end
#APP:add BFBLYB-435 by lizhao 20180820 end

#APP: add BFBLYB-134 by hanxin.zhang 2018/9/6 start
TRAN_MANUAL_GUIDE_SUPPORT = TECNO-B1f
#APP: add BFBLYB-134 by hanxin.zhang 2018/9/6 end

#APP: Add by fuyu for BFBLYB-1001 20190307 start
TRANSSION_RELEASEV_DELETE = yes
#APP: Add by fuyu for BFBLYB-1001 20190307 end

#APP: add BFBLYB-134 by dulei 20180929 start
TRAN_TORCH_TWO_SUPPORT = yes
#APP: add BFBLYB-134 by dulei 20180929 end

#TDD: add BFBLYB-872 by wenqiang.zhang 20181017 start
PRODUCT_PROPERTY_OVERRIDES += ro.product.first_api_level=27
#TDD: add BFBLYB-872 by wenqiang.zhang 20181017 end
#APP: Add by fuyu for BFBLYB-1180 20190327 start
TRAN_GMS_MUSIC_UNINSTALL = no
#APP: Add by fuyu for BFBLYB-1180 20190327 end
#SID2: add XLLJHBLEW-875 by zhangzhishui 20190108 start
TRAN_HIDE_SUPPORT = yes
#SID2: add XLLJHBLEW-875 by zhangzhishui 20190108 end
#APP:add faceunlock by jiacheng.gu 20190305 start
TRAN_FACEID_SUPPORT = yes
#APP:add BFBLYB-1123 faceunlock by jiacheng.gu start
TRAN_FACEID_DISABLE_ICON = yes
#APP:add BFBLYB-1123 faceunlock by jiacheng.gu end

#APP:add faceunlock by jiacheng.gu 20190305 end
